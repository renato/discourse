...
import { getComposerImplementationCount } from "composer-kit/extensions";
...
export default class ComposerEditorSelector extends Component {
  ...
  <template>
    {{#if this.hasMultipleEditorImpl}}
      <DMenu
        class={{concatClass "composer-editor-selector" "btn-flat"}}
        ...
        <div class="composer-editor-selector-dropdown">
          ...
          <ul class="composer-editor-selector-dropdown__list">
            {{#each @buttons as |button|}}
              <li
                class={{concatClass
                  "composer-editor-selector-dropdown__item"
                  button.id
                }}
              >
                <DButton
